        ...
        <div className="flex flex-col h-[calc(100vh-8rem)]">
            <div className="flex items-center justify-between mb-6">
                <div>
                    ...
                    <p className="text-muted-foreground mt-2">Track project stages from start to completion.</p>
                </div>
                ...
                {Array.from({ length: 4 }).map((_, colIndex) => (
                    <div key={colIndex} className="flex-none w-80 flex flex-col pt-1">
                        ...
                        <div className="flex-1 rounded-xl bg-muted/50 p-3 space-y-3">
                            {Array.from({ length: colIndex === 0 ? 3 : 1 }).map((_, cardIndex) => (
                                <div key={cardIndex} className="bg-card rounded-lg border shadow-sm p-4 space-y-3">

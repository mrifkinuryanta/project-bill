...
export async function PATCH(
    ...
    try {
        ...
        const { title, clientId, totalPrice, dpAmount, status, currency, deadline } = json
        ...
        if (updateData.totalPrice !== undefined || updateData.dpAmount !== undefined) {
            ...
            if (existing) {
                ...
                const effectiveDp = updateData.dpAmount !== undefined ? updateData.dpAmount : (existing.dpAmount ? Number(existing.dpAmount) : null)
...
export async function DELETE(
    ...
    try {
        ...
        const hasUnpaidInvoices = project.invoices.some(inv => inv.status === "unpaid")
